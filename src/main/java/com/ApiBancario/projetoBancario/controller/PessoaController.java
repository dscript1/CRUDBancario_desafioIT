package com.ApiBancario.projetoBancario.controller;
...
import com.ApiBancario.projetoBancario.service.PessoaService;
...
public class PessoaController {
	...
	public ResponseEntity<Page<Pessoa>> getAll(Pageable pageable){
		 Page<Pessoa> listaCliente = pessoaService.findAll(pageable);		
